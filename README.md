...
Please note that this project will not be updating the [GitHub Releases](https://github.com/devnoname120/useful-forks/releases) page anymore. We will now go through Chrome's Web Store to publish updates.
